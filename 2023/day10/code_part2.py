...
if __name__ == '__main__':
    ...
    for x in range(1, height - 1):
        outside = True
        y = 1
        while grid[x][y].character in '0.' and y < width - 1:
            print_grid(grid)
            print()
    ...
    for x in range(1, height - 1):
        outside = True
        y = width - 1
        while grid[x][y].character in '0.' and y > 0:
            print_grid(grid)
            print()
            grid[x][y].character = '0'
            y -= 1
    ...
    for y in range(1, width - 1):
        outside = True
        x = 1
        while grid[x][y].character in '0.' and x < height - 1:
            print_grid(grid)
            print()
            grid[x][y].character = '0'
            x += 1
    ...
    for y in range(1, width - 1):
        outside = True
        x = height - 1
        while grid[x][y].character in '0.' and x > 0:
            print_grid(grid)
            print()
            grid[x][y].character = '0'
            x -= 1
